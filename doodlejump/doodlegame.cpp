    ...
    tgameover(new QTimer)
{
    ...
    for(int i=0; i<nplatform1; i++){
        platform1[i] = new QGraphicsPixmapItem(QPixmap(":/pic/platform.png").scaled(platformSizex,platformSizey));
    ...
    for(int i=0; i<nplatform2; i++){
        platform2[i] = new QGraphicsPixmapItem(QPixmap(":/pic/platform2.png").scaled(platformSizex,platformSizey));
    ...
    for(int i=0; i<nprop1; i++){
        p1[i].setPixmap((QPixmap(":/pic/prop1.png")).scaled(prop1Sizex,prop1Sizey));
        p1[i].x = -50;
    ...
    for(int i=0; i<nprop2; i++){
        p2[i].setPixmap((QPixmap(":/pic/prop2.png")).scaled(prop2Sizex,prop2Sizey));
        p2[i].x = rand() % wprop2;
        p2[i].y = rand() % hprop2;
    ...
    for(int i=0; i<nmonster; i++){
        monster[i] = new QGraphicsPixmapItem(QPixmap(":/pic/monster.png").scaled(monsterSizex,monsterSizey));
        m[i].x = rand() % wmonster;
        m[i].y = rand() % hmonster;
    ...
    for(int i=0; i<nblackHole; i++){
        blackHole[i] = new QGraphicsPixmapItem(QPixmap(":/pic/blackhole.png").scaled(blackHoleSizex,blackHoleSizey));
    ...
    /*設置人物*/
    d = new doodler;
    d->setPixmap(QPixmap(":/pic/doodler.png").scaled(doodlerSizex,doodlerSizey));
...
void doodlegame::mousePressEvent(QMouseEvent *event){
    bullet *b = new bullet;
    b->setPixmap(QPixmap(":/pic/bullet.jpg").scaled(bulletSizex, bulletSizey));
